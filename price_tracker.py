"""
Gumtree Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Gumtree.

Docs  : https://docs.bright.cn/scraping-automation/web-scraper-api/overview
Info  : https://bright.cn/products/insights/price-tracker/gumtree
"""
...
# Set your Web Scraper ID after building your Gumtree scraper:
# https://bright.cn/products/web-scraper/gumtree
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Gumtree scraper at: https://bright.cn/products/web-scraper/gumtree\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Gumtree product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Gumtree products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Gumtree category page.

    Example:
        results = discover_by_category("https://gumtree.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.gumtree.com/product/sample-item-123456",
        # Add more Gumtree product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "gumtree_prices.json"
    ...
    # cat_results = discover_by_category("https://gumtree.com/category/sample", limit=50)
